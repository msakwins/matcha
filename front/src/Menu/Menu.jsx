...
import { LinkSettings, LinkFavs, LinkMessages, LinkProfile } from '../Styled';
...
const Menu = (props) => {
  ...
  return (
    ...
    <LinkFavs onClick={handleCloseMenu} menuclass={menuclass} selected={pathname === "/matches"} to="/matches">
      <span>Matches</span>
    </LinkFavs>
